...
import { Link, Outlet, Router, RouterProvider, rootRouteWithContext } from '@tanstack/react-router'
...
export const router = new Router({ routeTree: routeTree, defaultPreload: 'intent', context: { queryClient: queryClient } })
